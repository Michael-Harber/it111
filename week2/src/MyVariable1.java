...
String name = "Michael"; // after a statement, don't forget the semi colon!
            int hours = 40; // we are assigning 40 to the hours variable
            // Please note that when we have a string valuer, it is nested in ""
            //when we are referring to numbers/integers, no quotes!!!
        System.out.println(name);
        System.out.println(hours);

        String tree, building, lake, ocean;
        tree = "Redwood";
