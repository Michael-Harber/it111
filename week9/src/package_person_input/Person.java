...
public class Person {
    ...
    // our method for states /zip codes/ strings/ changing your string to an integer
    ...
    // method to charge a surcharge to people who live in california, because there are so many cars, pollution, etc etc.
